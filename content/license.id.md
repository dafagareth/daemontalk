# Lisensi & Hak Penggunaan Daemontalk
...
## 1. Kode Sumber Platform & Peladen (*PolyForm Noncommercial 1.0.0*)
...
- **Wajib Berbagi Serupa (Share-Alike)**: Jika Anda menggubah atau membuat karya turunan, Anda wajib merilisnya di bawah lisensi yang sama.

---

## 3. Merek Dagang & Identitas Visual (*Seluruh Hak Cipta Dilindungi*)

Nama **Daemontalk**, domain (`daemontalk.com`), logo mekanik daemon, token desain, gaya visual, dan seluruh elemen identitas merek adalah kekayaan intelektual eksklusif milik **Dafa Gareth**. **Seluruh hak cipta dilindungi undang-undang (*All Rights Reserved*).** Tidak ada izin yang diberikan untuk mengkloning atau menggunakan identitas merek ini untuk tujuan apa pun tanpa izin tertulis.

---

## 4. Cuplikan Kode & Konfigurasi pada Artikel (*Permissive / MIT*)

Seluruh cuplikan kode pemrograman (*code snippets*), resep sysctl, konfigurasi kernel Linux, skrip shell, dan skema database yang disematkan di dalam artikel teknis disediakan di bawah lisensi terbuka permisif. Anda bebas menyalin, memodifikasi, dan mengeksekusi cuplikan kode tersebut ke dalam sistem produksi pribadi maupun komersial Anda tanpa royalti.

---

## 5. Batasan Jaminan Perangkat Lunak (*As-Is Terms*)

Perangkat lunak dan dokumentasi ini disediakan sebagaimana adanya (*as-is*), tanpa jaminan apa pun. Pemilik hak cipta tidak bertanggung jawab atas segala kerusakan, kehilangan data, *kernel panic*, atau *downtime* server yang timbul dari penggunaan atau pengujian perangkat lunak ini.

Pertanyaan terkait izin komersial atau perjanjian lisensi khusus dapat dialamatkan ke: **realdaemontalk@gmail.com**.
