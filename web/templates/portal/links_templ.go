...
import "daemontalk/web/templates/shared"
...
func categoryMultiLinks(tagKey string, lang string, linkClass string, separatorClass string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for i, l := range links {
			if i > 0 {
				var templ_7745c5c3_Var2 = []any{separatorClass}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/portal/links.templ`, Line: 1, Col: 0}
				}
			...
			var templ_7745c5c3_Var4 = []any{linkClass}
			...
			templ_7745c5c3_Var5, templ_7745c5c3_Err = templ.JoinURLErrs(templ.SafeURL(shared.Prefix(lang) + "/blog/tag/" + l.Slug))
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/portal/links.templ`, Line: 11, Col: 70}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/portal/links.templ`, Line: 12, Col: 11}
			}
