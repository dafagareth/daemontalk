...
func (h *Handler) AdminPostUploadMD(w http.ResponseWriter, r *http.Request) {
	...
	if err := r.ParseMultipartForm(common.MaxMarkdownUploadSize); err != nil {
...
func (h *Handler) AdminUploadImage(w http.ResponseWriter, r *http.Request) {
	...
	if err := r.ParseMultipartForm(common.MaxImageUploadSize); err != nil {
...
func (h *Handler) AdminPostFileEdit(w http.ResponseWriter, r *http.Request) {
	...
	common.Render(w, r, admin.Layout("admin", r.URL.Path,
		admin.MarkdownEditor(slug, string(data), p, isArchived, "")))
}
